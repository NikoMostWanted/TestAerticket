 ...
 */
final class Version20190427082720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE flight ADD CONSTRAINT FK_C257E60E4F335C8B FOREIGN KEY (transporter_id) REFERENCES transporter (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE flight DROP FOREIGN KEY FK_C257E60E4F335C8B');
